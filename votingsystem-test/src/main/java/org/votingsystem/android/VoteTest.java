...
import org.votingsystem.android.xml.XmlWriter;
...
public class VoteTest extends BaseTest {
    ...
    public void vote() throws Exception {
        ...
        if(ResponseDto.SC_OK == responseDto.getStatusCode()) {
            ...
            byte[] signedVote = new SignatureBuilder(voteStr.getBytes(), XAdESUtils.XML_MIME_TYPE,
                    ...
                    org.votingsystem.Constants.TIMESTAMP_SERVICE_DISCRETE_URL).build();
    ...
    public static void saveKeyStore(MockDNIe mockDNIe, String keyStorePath) throws Exception {
        ...
        store.setKeyEntry("userkey", mockDNIe.getPrivateKey(), org.votingsystem.util.Constants.PASSW_DEMO.toCharArray(),
                mockDNIe.getCertificateChain());
        byte[] keyStoreBytes = KeyStoreUtils.toByteArray(store, org.votingsystem.util.Constants.PASSW_DEMO.toCharArray());
