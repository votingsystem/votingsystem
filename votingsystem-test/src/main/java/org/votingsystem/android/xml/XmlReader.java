...
public class XmlReader {
    ...
    public static IdentityRequestDto readIdentityRequest(byte[] xmlBytes) throws IOException, XmlPullParserException {
        ...
        if(mainElement.getAttributeValue(null, "Date") != null) {
            log.info("====" + org.votingsystem.android.xml.DateUtils.getXmlDate(mainElement.getAttributeValue(null, "Date")));
        }
    ...
    public static ElectionDto getElection(Element electionElement) throws IOException, XmlPullParserException {
        ...
        election.setDateBegin(DateUtils.getDateFromISO_OFFSET_DATE_TIME(XMLUtils.getTextChild(electionElement, "DateBegin")));
        election.setDateFinish(DateUtils.getDateFromISO_OFFSET_DATE_TIME(XMLUtils.getTextChild(electionElement, "DateFinish")));
