...
public class EncryptTest extends BaseTest {
    ...
    private static byte[] encrypt(SignatureBuilder signatureService) throws Exception {
    ...
    private static void signAndEncrypt(SignatureBuilder signatureService) throws Exception {
        log.info("signAndEncrypt");
