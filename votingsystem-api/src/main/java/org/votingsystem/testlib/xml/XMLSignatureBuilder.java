...
public class XMLSignatureBuilder {
    ...
    private static final Logger log = Logger.getLogger(XMLSignatureBuilder.class.getName());
     ...
     */
    public XMLSignatureBuilder(byte[] documentToSignBytes, String documentToSignMimeType,
     ...
     * - Has attributes in alphabetical order.
     */
    public XMLSignatureBuilder(byte[] documentToSignBytes, String documentToSignMimeType, String signatureAlgorithm,
