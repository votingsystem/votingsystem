...
class EventoVotacionController {
	 ...
	 * @return Página con votaciones en formato JSON que cumplen con el criterio de búsqueda.
	 */
    def obtener () {
        def eventoList = []
	 ...
	 * @return Estadísticas asociadas a la votación que se desea consultar en formato JSON.
	 */
    def estadisticas () {
        if (params.long('id')) {
