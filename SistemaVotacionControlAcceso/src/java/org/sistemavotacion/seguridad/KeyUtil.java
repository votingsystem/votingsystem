...
public class KeyUtil {
    ...
    public static X500PrivateCredential createRootCredential(Date fechaIncio, 
            Date fechaFin, String rootAlias, String strSubjectDN) throws Exception {
    	KeyPair rootPair = generateRSAKeyPair();
    	X509Certificate rootCert = CertUtil.generateV3RootCert(
                rootPair, fechaIncio, fechaFin, strSubjectDN);
    ...
    public static X500PrivateCredential createEndEntityCredential(PrivateKey caKey, 
    		X509Certificate caCert, Date fechaInicio, Date fechaFin, 
        ...
        X509Certificate endCert = CertUtil.generateEndEntityCert(endPair.getPublic(), 
        		caKey, caCert, fechaInicio, fechaFin, endEntitySubjectDN);
