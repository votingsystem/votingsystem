...
public class SernoGenerator {
    ...
    private static Logger logger = (Logger) LoggerFactory.getLogger(SernoGenerator.class);
	 ...
	 */
	protected SernoGenerator(MessageSource messageSource) throws Exception {
		logger.debug(" - SernoGenerator()");
	 ...
	 */
	public static synchronized SernoGenerator instance(MessageSource messageSource) throws Exception {
		if (instance == null) {
			instance = new SernoGenerator(messageSource);
		}
		return instance;
	}
	 ...
	 */
	public synchronized BigInteger getSerialNumber() {
