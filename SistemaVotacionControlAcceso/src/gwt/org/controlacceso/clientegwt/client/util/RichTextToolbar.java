...
public class RichTextToolbar extends Composite {
	...
	//GUI Related stuff
	private static final String GUI_DIALOG_INSERTURL = "Introducir URL de enlace:";
	private static final String GUI_DIALOG_IMAGEURL = "Introducir URL de la imagen:";

	private static final String GUI_LISTNAME_COLORS = "Colores";
	private static final String GUI_LISTNAME_FONTS = "Fuentes";
	
	private static final String GUI_HOVERTEXT_SWITCHVIEW = "Ver fuentes HTML";
	private static final String GUI_HOVERTEXT_REMOVEFORMAT = "Eliminar formato";
	private static final String GUI_HOVERTEXT_IMAGE = "Insertar imagen";
	private static final String GUI_HOVERTEXT_HLINE = "Insertar línea horizontal";
	private static final String GUI_HOVERTEXT_BREAKLINK = "Romper enlace";
	private static final String GUI_HOVERTEXT_LINK = "Generar enlace";
	private static final String GUI_HOVERTEXT_IDENTLEFT = "Sangría izquierda";
	private static final String GUI_HOVERTEXT_IDENTRIGHT = "Sangría derecha";
	private static final String GUI_HOVERTEXT_UNORDERLIST = "Lista no ordenada";
	private static final String GUI_HOVERTEXT_ORDERLIST = "Lista ordenada";
	private static final String GUI_HOVERTEXT_ALIGNRIGHT = "Alinear a derecha";
	private static final String GUI_HOVERTEXT_ALIGNCENTER = "Alinear centrado";
	private static final String GUI_HOVERTEXT_ALIGNLEFT = "Alinear izquierda";
	private static final String GUI_HOVERTEXT_SUPERSCRIPT = "Superíndicet";
	private static final String GUI_HOVERTEXT_SUBSCRIPT = "Subíndice";
	private static final String GUI_HOVERTEXT_STROKE = "Tachar";
	private static final String GUI_HOVERTEXT_UNDERLINE = "Subrayar";
	private static final String GUI_HOVERTEXT_ITALIC = "Cursiva";
	private static final String GUI_HOVERTEXT_BOLD = "Negrita";
	...
	public String getHTML() {
		String result = styleText.getHTML().replace("<br>", "<br/>");
	...
	private void buildTools() {
		...
		HorizontalPanel panelFuentes = new HorizontalPanel();
		panelFuentes.add(new HTML("&nbsp;"));
		panelFuentes.add(fontlist = createFontList());
		panelFuentes.add(new HTML("&nbsp;"));
		panelFuentes.add(colorlist = createColorList());
		panelFuentes.setStyleName("panelFuentes");
		topPanel.setStyleName(CSS_ROOT_NAME);
		topPanel.add(panelFuentes);
	}
