...
(function($) {
	...
	$.fn.draw = function(o,obj,selectedpage){
		...
		var _first		= $(document.createElement('a')).addClass('jPag-first').html(Message.firstPageLbl );
		...
		var _last		= $(document.createElement('a')).addClass('jPag-last').html(Message.lastPageLbl);
