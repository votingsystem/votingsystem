<script>
    ...
    function getTransactionVSDescription(transactionType) {
        ...
        switch(transactionType) {
            case 'COOIN_REQUEST':
                transactionDescription = "<g:message code="selectCooinRequestLbl"/>"
                break;
            case 'COOIN_SEND':
            ...
            case 'COOIN_INIT_PERIOD':
                ...
                break;
            case 'COOIN_INIT_PERIOD_TIME_LIMITED':
                transactionDescription = "<g:message code="cooinInitPeriodTimeLimitedLbl"/>"
                break;
            case 'FROM_BANKVS':
