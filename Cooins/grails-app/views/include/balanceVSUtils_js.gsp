<script>
    ...
    function tagDataIncomesDetailsForChartDonut(seriesData) {
        ...
        for(idx in seriesData) {
            ...
            //add expense
            result.push({
                name: '<g:message code="timeLimitedLbl"/>',
                tag:tagData.name,
                y: tagData.data[2],
            ...
            result.push({
                name: '<g:message code="timeFreeLbl"/>',
                tag:tagData.name,
    ...
    function tagDataExpensesForChartDonut(seriesData) {
        ...
        for(idx in seriesData) {
            ...
            //add timelimited
            result.push({
                name: '<g:message code="expendedLbl"/>',
                tag:tagData.name,
                y: tagData.data[1],
                color: 'red'
            });
            ...
            result.push({
                name: '<g:message code="availableLbl"/>',
                tag:tagData.name,
                y: available,
        ...
        result.forEach(function(data) {
            if('WILDTAG' === data.tag && data.name === '<g:message code="availableLbl"/>') {
