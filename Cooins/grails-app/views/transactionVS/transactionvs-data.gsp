...
<polymer-element name="transactionvs-data" attributes="transactionvs smimeMessage isClientToolConnected timeStampDate">
    ...
    <script>
            ...
            transactionvsChanged:function() {
                ...
                switch (this.transactionvs.type) {
                    ...
                    case 'COOIN_INIT_PERIOD':
                        ...
                        break;
                    case 'COOIN_SEND':
                        this.caption = "<g:message code="cooinSendLbl"/>"
       ...
       // "currency":"EUR","messageSMIMEURL":"http://cooins:8086/Cooins/messageSMIME/35","numChildTransactions":1,"tags":[{"id":3,"name":"HIDROGENO"}]}
