...
class GroupVSController {
        ...
        if(params.long('id')) {
            ...
            if("POST".equals(request.method)) {
                ...
                if(ResponseVS.SC_OK == responseVS.getStatusCode()) {
                    ...
                    responseVS.data = [statusCode:ResponseVS.SC_OK, message:message(code:'cooinGroupEditedOKMsg',
    ...
    def cancel() {
        if(params.long('id')) {
            ...
            if(ResponseVS.SC_OK == responseVS.getStatusCode()) {
                String URL = "${createLink(controller: 'groupVS', absolute:true)}/${groupVS.id}"
                responseVS.data = [statusCode:ResponseVS.SC_OK, message:message(code:'cooinGroupCancelledOKMsg',
                        args:[groupVS.name]), URL:URL]
                responseVS.setContentType(ContentTypeVS.JSON)
            }
            return [responseVS:responseVS]
