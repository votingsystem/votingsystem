 ...
 */
public class BrowserVSStackPane extends StackPane {

    private static Logger logger = Logger.getLogger(BrowserVSStackPane.class);
    ...
    public BrowserVSStackPane(SignatureService signatureService) {
