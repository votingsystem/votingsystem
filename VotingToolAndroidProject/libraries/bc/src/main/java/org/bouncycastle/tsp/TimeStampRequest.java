    ...
    implements java.security.cert.X509Extension
{
    ...
    */
    ...
    public byte[] getExtensionValue(String oid)
    {
        ...
        if (exts != null)
        {
            org.bouncycastle2.asn1.x509.X509Extension   ext = exts.getExtension(new DERObjectIdentifier(oid));
        ...
        boolean critical)
    {
        ...
        if (extensions != null)
        {
            ...
            while (e.hasMoreElements())
            {
                ...
                org.bouncycastle2.asn1.x509.X509Extension ext = extensions.getExtension(oid);
