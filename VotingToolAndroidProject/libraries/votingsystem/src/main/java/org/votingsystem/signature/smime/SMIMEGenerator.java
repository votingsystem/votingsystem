...
public class SMIMEGenerator
{
    ...
    static
    {
        ...
        BASE_CIPHER_NAMES.put(CMSEnvelopedGenerator.DES_EDE3_CBC,  "des_EDE3_CBC");
        BASE_CIPHER_NAMES.put("des_EDE3_CBC",  "des_EDE3_CBC");
        
        BASE_CIPHER_NAMES.put(CMSEnvelopedGenerator.DES_EDE3_CBC,  "des_EDE3");
