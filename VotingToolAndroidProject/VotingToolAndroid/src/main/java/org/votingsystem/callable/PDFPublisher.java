...
public class PDFPublisher implements Callable<ResponseVS> {
    ...
    @Override public ResponseVS call() {
        ...
        try {
            ...
            Header header = new Header(ContextVSAndroid.VOTING_HEADER_LABEL,"SignedPDF");
            MimeBodyPart mimeBodyPart = Encryptor.encryptBase64Message(
                    timeStampedSignedPDF, ContextVSAndroid.getInstance(context).getAccessControl().
    ...
    public byte[] signWithTimestamp(PdfReader pdfReader,
        ...
        Log.d(TAG, "signWithTimestamp - UserVSBase: " + PdfPKCS7.getSubjectFields(signerCert).getField("CN"));
