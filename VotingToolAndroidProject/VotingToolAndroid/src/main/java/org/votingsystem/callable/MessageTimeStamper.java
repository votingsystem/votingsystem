    ...
    @Override public ResponseVS call() throws Exception {
        ...
        while(!done.get()) {
        	String timeStampServiceURL = ServerPaths.getURLTimeStampService(
                    ContextVSAndroid.getInstance(context).getAccessControlURL());
            ...
            if(ResponseVS.SC_OK == response.getStatusLine().getStatusCode()) {
                ...
                X509Certificate timeStampCert = ContextVSAndroid.getInstance(context).
                ...
                timeStampToken.validate(timeStampCert, ContextVSAndroid.PROVIDER);/**/
