 ...
 */
public class RepresentativeService1 extends Service {

    public static final String TAG = "RepresentativeService1";
    ...
    private void sendMessage(Integer statusCode, String message) {
        ...
        LocalBroadcastManager.getInstance(RepresentativeService1.this).sendBroadcast(intent);
    }
