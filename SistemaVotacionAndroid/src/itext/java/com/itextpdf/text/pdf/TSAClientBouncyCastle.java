/*
 * $Id: TSAClientBouncyCastle.java 4978 2011-10-11 23:06:19Z psoares33 $
 *
...
public class TSAClientBouncyCastle implements TSAClient {
    ...
    public byte[] getTimeStampToken(byte[] imprint) throws Exception {
        ...
        try {//jjgz
            ...
            //jjgzTimeStampRequest request = tsqGenerator.generate(PdfPKCS7.getAllowedDigests(getDigestAlgorithm()), imprint, nonce);
            ...
            //jjgzPKIFailureInfo failure = response.getFailInfo();
            PKIFailureInfo failure = null;
