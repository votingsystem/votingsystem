...
public class EventFragment extends Fragment implements CertPinDialogListener {
    ...
    @Override public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        event = appData.getEvents().get(eventIndex);
        ...
        firmarEnviarButton.setOnClickListener(new Button.OnClickListener() {
            public void onClick(View v) {
                ...
                if (event.getTipo().equals(Tipo.EVENTO_RECLAMACION)) {
    ...
    private void showCertNotFoundDialog() {
        ...
        Fragment prev = getActivity().getSupportFragmentManager().findFragmentByTag(AppData.CERT_NOT_FOUND_DIALOG_ID);
        if (prev != null) {
            ft.remove(prev);
        }
    ...
    private void showClaimFieldsDialog() {
        ...
        Set<CampoDeEvento> campos = event.getCampos();
    ...
    private class ProcessSignatureTask extends AsyncTask<URL, Integer, Respuesta> {
        ...
        protected Respuesta doInBackground(URL... urls) {
            ...
            try {
                ...
                if(event.getTipo().equals(Tipo.EVENTO_FIRMA)) {
                ...
                } else if(event.getTipo().equals(Tipo.EVENTO_RECLAMACION)) {
                    ...
                    SMIMESignedSender smimeSignedSender = new SMIMESignedSender(serviceURL,
                            ...
                            appData.getControlAcceso().getCertificado(), getActivity().getBaseContext());
