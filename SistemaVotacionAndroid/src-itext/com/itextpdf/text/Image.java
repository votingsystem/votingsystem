...
public abstract class Image extends Rectangle implements Indentable, Spaceable {
	 ...
	 *             on error
	 */
	public static Image getInstance(final Object image, final Object color,
	 ...
	 * @throws IOException
	 */
	public static Image getInstance(final PdfWriter writer, final Object awtImage, final float quality) throws BadElementException, IOException {
     ...
     * @throws IOException
     */
    public static Image getInstance(final PdfContentByte cb, final Object awtImage, final float quality) throws BadElementException, IOException {
    	return null;
    }
