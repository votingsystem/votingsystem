/*
 * $Id: PdfPKCS7.java 4979 2011-10-17 22:04:19Z psoares33 $
 *
...
import org.bouncycastle2.jce.provider.RFC3280CertPathUtilities;

/**
 * This class does all the processing related to signing and verifying a PKCS#7
 * signature.
 * <p>
 * It's based in code found at org.bouncycastle2.
 */
public class PdfPKCS7 {
        ...
        try {
            ...
            if (next < signerInfo.size() && signerInfo.getObjectAt(next) instanceof DERTaggedObject) {
                ...
                if (ts != null && ts.getAttrValues().size() > 0) {
                    ...
                    //jjgz this.timeStampToken = new TimeStampToken(contentInfo);
                }
            }
    ...
    public boolean verifyTimestampImprint() throws NoSuchAlgorithmException {
        if (timeStampToken == null)
            return false;
        /*jjgzMessageImprint imprint = timeStampToken.getTimeStampInfo().toTSTInfo().getMessageImprint();
