...
class ObjectDataContentHandler implements DataContentHandler {
	...
	public void writeTo(Object obj, String mimeType, OutputStream os)
		...
		//Log.i("DataHandler.writeTo", "obj.getClass().getName(): " + obj.getClass().getName());
		    ...
		    osw.flush();
		} else if (obj instanceof SMIMESignedGenerator.ContentSigner) {
			SMIMESignedGenerator.ContentSigner contentSigner = (SMIMESignedGenerator.ContentSigner)obj;
			contentSigner.write(os);
