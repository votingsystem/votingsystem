...
public class EC5Util
{
    ...
    public static org.bouncycastle2.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new org.bouncycastle2.jce.spec.ECParameterSpec(
            curve,
    ...
    public static org.bouncycastle2.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
