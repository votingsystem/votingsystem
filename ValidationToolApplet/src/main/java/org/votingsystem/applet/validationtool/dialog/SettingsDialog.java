...
public class SettingsDialog extends JDialog {
    ...
    private static final String WITH_KEYSTORE_PROPERTY = "WITH_KEYSTORE_PROPERTY";
    ...
    private void initComponents() {
        Boolean withKeystore = ContextVS.getInstance().getBoolProperty(WITH_KEYSTORE_PROPERTY);
        if(withKeystore == null) withKeystore = false;
    ...
    private void validateSettings() {
        ...
        Boolean withKeystoreSettings = ContextVS.getInstance().getBoolProperty(WITH_KEYSTORE_PROPERTY);
        if(withKeystoreSettings == null) withKeystoreSettings = false;
        if(signWithKeystoreCheckBox.isSelected() != withKeystoreSettings) {
            try {
                ...
                if(!signWithKeystoreCheckBox.isSelected())
                    ContextVS.getInstance().setProperty(WITH_KEYSTORE_PROPERTY,
