...
public class DecompressFileDialog extends javax.swing.JDialog {
    ...
    public DecompressFileDialog(java.awt.Frame parent, boolean modal) {
        ...
        setTitle(ContextVS.INSTANCE.getString("decompressBackupCaption"));
        progressBar.setStringPainted(true);
        setLocationRelativeTo(null);
    }

    public boolean unZipBackup(final String zipFilePath, final String outputFolder){
        runningTask = ValidationToolContext.INSTANCE.submit(new Callable() {
            @Override
    ...
    */
    private ResponseVS unZip(String zipFilePath, String outputFolder){
        logger.debug("unZipIt: " + zipFilePath + " - outputFolder: " + 
                outputFolder);
        backupFileLabel.setText(ContextVS.INSTANCE.getString(
