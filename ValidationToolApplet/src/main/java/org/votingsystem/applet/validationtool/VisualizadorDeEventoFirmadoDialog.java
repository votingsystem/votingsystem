...
public class VisualizadorDeEventoFirmadoDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        tabbedPane = new org.votingsystem.applet.validationtool.ClosableTabbedPane();
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (file.getName().indexOf(".") == -1) {
                    String fileName = file.getAbsolutePath() + 
                            ContextVS.SIGNED_PART_EXTENSION;
     ...
     private String checkFileSize (File file) {
        ...
        if (file.length() > ContextVS.SIGNED_MAX_FILE_SIZE) {
            result = ContextVS.INSTANCE.getString("fileSizeExceededMsg", 
                        file.length() , ContextVS.SIGNED_MAX_FILE_SIZE_KB);
        }
        return result;
    }
    ...
    public void setVisible(String decompressedBackupBaseDir) {
        ...
        if(!metaInfFile.exists()) {
            String message = ContextVS.INSTANCE.getString(
                    "metaInfNotFoundMsg", 
    ...
    private org.votingsystem.applet.validationtool.ClosableTabbedPane tabbedPane;
