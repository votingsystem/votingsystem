...
public class FirmantePanel extends javax.swing.JPanel implements ItemListener {
    ...
    private static Logger logger = Logger.getLogger(FirmantePanel.class);
    
    private UserVSBase signerVS;
    ...
    public FirmantePanel(UserVS signer, SMIMEMessageWrapper signedMessage) 
            throws Exception {
        initComponents();
        ...
        this.signerVS = (UserVSBase)signer;
        valorAlgoritmoFirmaLabel.setText(signerVS.getEncryptiontId() + " - " + 
                signerVS.getDigestId());
        if(signerVS.getTimeStampToken() == null) {
            timeStampButton.setVisible(false);
        } else {
        }
        valorFechaFirmaLabel.setText(DateUtils.
                getSpanishFormattedStringFromDate(signerVS.getSignatureDate()));
        firmanteEditorPane.setText(Formatter.getInfoCert(signerVS.getCertificate()));
        textoEditorPane.setText(signedMessage.getSignedContent());
        hashBase64TextField.setText(signerVS.getContentDigestBase64());
        hashHexadecimalTextField.setText(signerVS.getContentDigestHex());
        firmaBase64TextField.setText(signerVS.getSignatureBase64());
        firmaHexadecimalTextField.setText(signerVS.getFirmaHex());
        if(signerVS.getTimeStampToken() == null) timeStampButton.setVisible(false);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(firmaBase64Label)
                    .addComponent(hashHexadecimalLabel)
                    .addComponent(textoScrollPane, javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(algoritmoFirmaLabel)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(timeStampButton, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(fechaFirmaLabel, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void timeStampButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timeStampButtonActionPerformed
        TimeStampToken timeStampToken = signerVS.getTimeStampToken();
    ...
    @Override public void itemStateChanged(ItemEvent e) {
        ...
        if (!checkBox.isSelected()) {
            try {
                textoConFormato = Formatter.procesar(
        ...
        } else textoEditorPane.setText(signedMessage.getSignedContent());  
    }
}
