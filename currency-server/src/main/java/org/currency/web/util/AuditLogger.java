...
public class AuditLogger {
    ...
    public static final String CURRENCY_ISSUED_LOG_FILE_PATH = "/var/local/wildfly/currency_server/reports/currency_issued.log";
    public static final String TRANSACTIONS_LOG_FILE_PATH = "/var/local/wildfly/currency_server/reports/transactions.log";
    public static final String WEEK_PERIOD_LOG_FILE_PATH = "/var/local/wildfly/currency_server/reports/week_period.log";
    public static final String REPORTS_FILE_LOG_PATH = "/var/local/wildfly/currency_server/reports/reports.log";
