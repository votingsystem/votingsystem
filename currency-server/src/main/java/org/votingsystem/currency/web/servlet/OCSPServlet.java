package org.votingsystem.currency.web.servlet;
...
import org.votingsystem.currency.web.ejb.CurrencyIssuerEJB;
...
public class OCSPServlet extends HttpServlet {
    ...
    @EJB
    CurrencyIssuerEJB currencyIssuer;
    ...
    protected void processRequest(HttpServletRequest req, HttpServletResponse res)
        ...
        RootCertOCSPInfo rootCertOCSPInfo = currencyIssuer.getRootCertOCSPInfo();
        try {
