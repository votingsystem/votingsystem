...
public class AuditEJB {
    ...
    public void checkLapsedCurrency() {
        ...
        List<org.votingsystem.model.currency.Currency> currencyList = em.createQuery(
                ...
                .setParameter("state", org.votingsystem.model.currency.Currency.State.OK).getResultList();
        for(org.votingsystem.model.currency.Currency currency :currencyList) {
            em.merge(currency.setState(org.votingsystem.model.currency.Currency.State.LAPSED));
