...
var locationProtHostAndPort = location.protocol+'//'+location.hostname+(location.port ? ':'+location.port: '')
var CURRENT_URL = vs.parentURL ? (locationProtHostAndPort + vs.parentURL) : window.location.href;
