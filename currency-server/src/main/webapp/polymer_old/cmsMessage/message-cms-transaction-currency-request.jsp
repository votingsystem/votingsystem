...
<dom-module name="message-cms-transaction-currency-request">
    <template>
        <style>
    ...
    <script>
        Polymer({
            is:'message-currency-transaction-currency-request',
            properties: {
            ...
            ready: function() {
                ...
                sendSignalVS({caption:"${msg.transactionCurrencyRequest}"})
            },
