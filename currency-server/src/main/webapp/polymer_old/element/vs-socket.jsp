        ...
        Polymer({
            ...
            connect: function() {
                ...
                this.websocket.onmessage = function (event) {
                    ...
                    if("MSG_FROM_SERVER" ===  messageJSON.operation) {
                        ...
                        switch(messageJSON.messageType) {
                            ...
                            case 'GENERATE_BROWSER_CERTIFICATE':
                                ...
                                if(qrOperation.operation !== 'GENERATE_BROWSER_CERTIFICATE') {
                                    throw new Error('GENERATE_BROWSER_CERTIFICATE - qrOperation ERROR');
                                }
                                ...
                                var encryptedDto = {operation:'GENERATE_BROWSER_CERTIFICATE',
                                ...
                                console.log("GENERATE_BROWSER_CERTIFICATE response: ", socketMessageDto)
            ...
            showOperationQRCode:function (socketSystem, operationVS, operationCode) {
                ...
                switch (operationVS.qrOperationCode) {
                    case vs.QROperationCode.GET_AES_PARAMS:
                        ...
                        break;
                    case vs.QROperationCode.GENERATE_BROWSER_CERTIFICATE:
