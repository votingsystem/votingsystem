...
public class FirmantesDialog extends JDialog {
    ...
    private static Logger logger = LoggerFactory.getLogger(FirmantesDialog.class);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FirmantesDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                FirmantesDialog dialog = new FirmantesDialog(new javax.swing.JFrame(), true);
