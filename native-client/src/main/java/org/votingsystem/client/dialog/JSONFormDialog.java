 ...
 */
public class JSONFormDialog extends AppDialog {
    ...
    public JSONFormDialog() {
        ...
        Button cancelButton = new Button(Messages.currentInstance().get("cancelLbl"));
    ...
    public static void show(Map formData, Listener listener) {
        PlatformImpl.runLater(() -> {
            try {
                ...
                dialog.showMessage(Messages.currentInstance().get("enterReceptorMsg"), formData, listener);
