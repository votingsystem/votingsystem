...
public class AccessRequestVSResource {
    ...
    public Response getById(@PathParam("id") long id, @Context ServletContext context,
        ...
        if(accessRequestVS == null) return Response.status(Response.Status.NOT_FOUND).entity(config.get("ERROR - "
    ...
    public Response findByEventAndNif(@PathParam("eventId") long eventId, @PathParam("nif") String nif,
        ...
        if(eventVS == null) return Response.status(Response.Status.NOT_FOUND).entity(config.get("ERROR - "
        ...
        if(userVS == null) return Response.status(Response.Status.NOT_FOUND).entity(config.get("ERROR - "
