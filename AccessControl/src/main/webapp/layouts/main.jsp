                    ...
                    <core-selector id="coreSelector" selected="{{coreSelectorValue}}" valueattr="data-href" on-core-select="{{drawerItemSelected}}">
                        <c:choose>
                            <c:when test="${'admin'.equals(param.menu)}">pizza.
                                ...
                                <paper-item data-href="${config.webURL}/eventVSElection/editor">
                                    <i class="fa fa-envelope" style="margin:0px 10px 0px 0px;"></i> ${msg.publishVoteLbl}
                                </paper-item>
                                <paper-item data-href="${config.webURL}/representative">
                                    <i class="fa fa-hand-o-right" style="margin:0px 10px 0px 0px;"></i> ${msg.representativesPageLbl}
                                </paper-item>
                                <paper-item data-href="${config.webURL}/representative/newRepresentative">
                            ...
                            <c:otherwise>pizzas.
                                ...
                                <paper-item data-href="${config.webURL}/app/tools">
