...
public class ActorConIP implements Serializable {
    ...
    private static Logger log = Logger.getLogger(ActorConIP.class);
     ...
     */
    public void setTypeServidor(TypeVS serverType) {
    ...
    public static ActorConIP parse(String actorConIPStr) throws Exception {
        ...
        if (actorConIPJSON.containsKey("serverType")){
            TypeVS serverType = TypeVS.valueOf(actorConIPJSON.getString("serverType"));
            actorConIP.setTypeServidor(serverType);
        }
