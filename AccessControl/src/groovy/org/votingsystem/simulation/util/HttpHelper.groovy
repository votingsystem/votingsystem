...
public class HttpHelper {
    ...
    public ResponseVS sendFile (File file, String contentType, String serverURL, String... headerNames) {
        log.debug("sendFile - contentType: " + contentType + " - serverURL: " + serverURL);
        ResponseVS responseVS = null;
        ...
        try {
            ...
            for(String objectName: fileNames){
                ...
                if(objectToSend instanceof File) {
                    ...
                    log.debug("sendFileMap - fileName: " + objectName + " - filePath: " + file.getAbsolutePath());
