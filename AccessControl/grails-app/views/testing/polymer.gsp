...
<div layout vertical style="width:1200px;height: 1200px;margin:0px auto; ">
    <div layout horizontal>
        <vs-button onclick="showMessageVS('msg msg msg ', 'caption', null, false)" style="margin:10px;">
            Message dialog        <i class="fa fa-pencil-square-o"></i></vs-button>
        <vs-button onclick="document.querySelector('#addControlCenterDialog').show()" style="margin:10px; ">addControlCenterDialog <i class="fa fa-check"></i></vs-button>
        <vs-button onclick="document.querySelector('#addVotingOptionDialog').toggle()" style="margin:10px; ">addVotingOptionDialog <i class="fa fa-check"></i></vs-button>
        <vs-button onclick="document.querySelector('#eventVSAdminDialog').opened = true" style="margin:10px; ">eventVSAdminDialog</vs-button>
        <vs-button onclick="showVotevsResultDialog()" style="margin:10px; ">votevsResultDialog</vs-button>
