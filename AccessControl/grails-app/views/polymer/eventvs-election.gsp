...
<polymer-element name="eventvs-election" attributes="opened">
    <template>
        ...
        <div class="pageContentDiv" style="width:100%;max-width: 1000px; padding:0px 20px 0px 20px;">
            <div id="messagePanel" class="messagePanel messageContent text-center" style="display: none;"></div>

            <template if="{{'admin' == menuType}}">
                <div class="text-center" style="">
                    <template if="{{'ACTIVE' == eventvs.state || 'AWAITING' == eventvs.state}}">
            ...
            <div class="eventPageContentDiv">
                <div style="width:100%;position:relative;">
                    <div class="eventContentDiv">{{eventvs.content}}</div>
                </div>
