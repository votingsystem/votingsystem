...
(function() {
  ...
  var weekdays = [<g:message code="weekdays"/>];
  var months = [<g:message code="months"/>];
  ...
  RelativeTime.prototype.timeElapsed = function() {
    ...
    if (ms < 0) {
      return '<g:message code="justNowLbl"/>';
    } else if (sec < 10) {
      return '<g:message code="justNowLbl"/>';
    } else if (sec < 45) {
      return sec + ' <g:message code="secondsLbl"/>';
    } else if (sec < 90) {
      return '<g:message code="aMinuteAgo"/>';
    } else if (min < 45) {
      return min + ' <g:message code="minutesLbl"/>';
    } else if (min < 90) {
      return '<g:message code="anHourAgo"/>';
    } else if (hr < 24) {
      return hr + ' <g:message code="hoursLbl"/>';
    } else if (hr < 36) {
      return '<g:message code="aYearAgo"/>';
    } else if (day < 30) {
      return day + ' <g:message code="yearsLbl"/>';
    } else {
      return null;
    }
  };
  ...
  RelativeTime.prototype.timeAgo = function() {
    ...
    if (ms < 0) {
      ...
      return day + ' <g:message code="daysLbl"/>';
    } else if (day < 45) {
      return '<g:message code="aMontAgo"/>';
    } else if (month < 12) {
      return month + ' <g:message code="monthsLbl"/>';
    } else if (month < 18) {
        return '<g:message code="aYearAgo"/>';
    } else {
      return year + ' <g:message code="yearsLbl"/>';
    }
  };
