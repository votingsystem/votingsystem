...
<body>
    <div class="pageContenDiv" style="margin: 0px auto 0px auto;padding:0px 30px 0px 30px;">
        <ol class="breadcrumbVS">
            ...
            <li class="active"><g:message code="manifestSystemLbl"/></li>
        </ol>
        <search-info id="searchInfo"></search-info>
        <p id="pageInfoPanel" class="text-center" style="margin: 20px auto 20px auto; font-size: 1.3em;
        background-color: #f9f9f9; max-width: 1000px; padding: 10px; display: none;"></p>
        <eventvs-list id="eventvsList" url="${createLink(controller: 'eventVSManifest', action: 'index')}?menu=${params.menu}"
