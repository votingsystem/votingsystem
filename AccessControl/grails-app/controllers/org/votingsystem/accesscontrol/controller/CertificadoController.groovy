...
class CertificadoController {
		...
		if (eventoVotacion) {
			...
			EventoVotacion.withTransaction { 
				certificadoCA = Certificado.findWhere(
					eventoVotacion:eventoVotacion, type:Certificado.Type.RAIZ_VOTOS)
			}
	...
	def deleteTestCerts() {
		ResponseVS respuesta = firmaService.deleteTestCerts()
		if(respuesta.statusCode == ResponseVS.SC_OK) {
			render "OK"
		} else render "ERROR"
	}
}