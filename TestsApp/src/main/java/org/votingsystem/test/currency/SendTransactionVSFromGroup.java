...
public class SendTransactionVSFromGroup {

    private static Logger log =  Logger.getLogger(SendTransactionVSFromGroup.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        GroupDto groupDto = HttpHelper.getInstance().getData(
                GroupDto.class, currencyServer.getGroupURL(simulationData.getGroupId()), MediaTypeVS.JSON);
        ...
        transactionVSPlanDto.setGroupDto(groupDto);


        transactionVSPlanDto.runGroupTransactions();
        simulationData.finishAndExit(ResponseVS.SC_OK, "currencyResultMap: " + transactionVSPlanDto.getGroupBalance());
    }
