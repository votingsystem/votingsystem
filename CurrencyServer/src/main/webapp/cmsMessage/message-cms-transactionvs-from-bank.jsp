...
<dom-module name="message-cms-transactionvs-from-bank">
    <template>
        <style>
    ...
    <script>
        Polymer({
            is:'message-cms-transactionvs-from-bank',
            properties: {
            ...
            ready: function() {
                ...
                sendSignalVS({caption:"${msg.transactionVSFromBank}"})
            },
