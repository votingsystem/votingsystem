...
<dom-module name="message-cms-transactionvs-from-bankvs">
    <template>
        <style>
        ...
        <div class="layout vertical center center-justified" style="margin: 0px auto; max-width:800px;">
            <div class="" style="margin: 0px auto; color: #667;">
                ...
                <div style="margin-left: 20px;">
                    ...
                    <div>
                        <div><b>${msg.bankVSLbl}: </b><span>{{cmsMessageContent.fromUserVS.name}}</span> -
                            <span class="iban-link" on-click="showFromUserVSByIBAN">{{cmsMessageContent.fromUserVS.iban}}</span></div>
                        <div><b>${msg.nameLbl}: </b><span>{{cmsMessageContent.fromUser}}</span></div>
    ...
    <script>
        Polymer({
            is:'message-cms-transactionvs-from-bankvs',
            properties: {
