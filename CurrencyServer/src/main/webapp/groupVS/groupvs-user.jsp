    ...
    <script>
        Polymer({
            ...
            ready:function(e) {
                ...
                document.querySelector("#voting_system_page").addEventListener('on-submit-reason',
                        function(e) {
                            ...
                            operationVS.serviceURL = vs.contextURL + "/rest/groupVS/deActivateUser"
            ...
            goToUserVSPage:function() {
                page.show(vs.contextURL + "/rest/userVS/id/" + this.userId)
            ...
            activateUser : function(e) {
                ...
                operationVS.serviceURL = vs.contextURL + "/rest/groupVS/activateUser"
