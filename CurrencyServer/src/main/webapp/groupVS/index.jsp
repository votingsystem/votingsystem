...
<html>
<head>
    <link href="${config.webURL}/groupVS/groupvs-list.vsp" rel="import"/>
</head>
<body>
...
<script>
    function processSearch(textToSearch) {
        ...
        document.querySelector("#groupvsList").url = "${config.restURL}/search/groupVS?searchText=" + textToSearch
    }
</script>