...
<body>
    <div class="pageContentDiv">
        <div class="text-justify" style="margin: 0 auto 0 auto; font-size: 1.2em;">
            <h3 class="pageHeader">currency, moneda electrónica basada en arquitecturas de clave pública.</h3>
            <ul>
        ...
        <div class="text-justify" style="margin: 20px auto 0 auto;font-size: 1.2em;">
            ...
            <p><b>¿Qué es un currency?</b> Es un certificado electrónico anónimo (sin información que pueda relacionarlo con el
            propietario) que tiene asociado un valor y que permite <b>intercambios monetarios anónimos de forma segura</b>.</p>
            <p><b>¿Cómo se produce un intercambio de currency?</b>
                El intercambio anónimo de moneda se puede producir de dos maneras:
            <ul>
                <li>
                    El usuario que desea hacer una transacción utiliza los <b>currency</b> para firmar electrónicamente un
                documento con los datos del beneficiario. El valor del intercambio corresponde al valor asociado al
                    <b>currency</b> con el que se firma el traspaso. <b>De esta forma el intercambio quedará reflejado en los
                registros del sistema y la identidad del receptor será pública, la identidad del pagador seguirá siendo
                anónima</b>
                </li>
                <li>
                    Mediante el intercambio directo de <b>currency</b>. Un usuario puede dar directamente a otro un <b>currency</b>
            ...
            <p><b>¿Cómo se que no van a utilizar los mismos currency en repetidas ocasiones?</b> No puedes saberlo, pero en
            caso de duda cada intercambio lleva incorporado un Sello de Tiempo. Si aparecen varios documentos firmados con
            el mismo currency sólo tiene valor el que tiene el <b>Sello de Tiempo</b> más antiguo.</p>
            <p><b>¿Quien puede emitir currency?</b> El sistema es libre, cualquiera puede instalarlo. Depende del usuario el
            confiar o no en los currency emitidos por una determinada organización. Puede ser utilizado por un centro
        ...
        <div class="text-justify" style="margin: 20px auto ;font-size: 1.2em;">
            ...
            con un <b>currency</b> con fecha límite también debe gastar ese dinero antes del límite.
            </p>
            <p><b>Retirada de efectivo sin fecha de límite.</b> La duración máxima de un currency sin fecha límite es un año.
            Si el usuario no desea consumir ese currency puede cangearlo sin problemas siempre antes de que supere su
            fecha de caducidad.
            </p>
        </div>
        ...
        <div class="text-justify" style="margin: 20px auto 300px auto;font-size: 1.2em;">
            ...
            estimen oportunas modificando parámetros como:
                <ul>
                    <li>Las <b>fecha de  caducidad</b> de los currency emitidos. Pueden emitirse currency que tengan una vida de
                    una hora, un día, un mes, un año ...</li>
                    <li>Añadiendo <b>etiquetas</b> a los currency que hagan que sólo puedan ser empleados en los
