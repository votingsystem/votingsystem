...
<body>
    <div class="pageContentDiv">
        ...
        <div class="text-justify" style="margin: 0 auto 0 auto; font-size: 1.2em;">
            ...
            <b>transacciones firmadas anónimas</b>, o mediante intercambio de directo de <b>currency</b></p>
            ...
            la identidad del pagador es anónima. Para este tipo de transacciones es necesario utilizar un <b>currency</b>.</li>
            <li>En los <b>intercambios directos de currency</b> permanecen anónimos tanto el cobrador como el pagador (aunque
            ...
            <h4>Notas sobre currency</h4>
            <ul>
                <li>El dinero para la retirada de currency sale siempre de la cuenta de <b>gastos libres</b></li>
                <li>El valor de un <b>currency</b> se puede hacer llegar a otro usuario utilizando el <b>currency</b> en una
                <b>transacción firmada anónima</b>, en cuyo caso el importe se ingresa en la cuenta del usuario,
                o entregando diréctamente el <b>currency</b></li>
                <li>Un <b>currency</b> pueden tener asociado una etiqueta para que la <b>transacción anónima firmada</b>
