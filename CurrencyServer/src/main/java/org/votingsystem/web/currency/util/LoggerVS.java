...
public class LoggerVS {
    ...
    private static final Logger log = Logger.getLogger(LoggerVS.class.getName());
    ...
    public static File getReportsLogFile() {
        return new File(LoggerVS.REPORTS_FILE_LOG_PATH);
    }

    public static File getWeekPeriodLogFile() {
        return new File(LoggerVS.WEEK_PERIOD_LOG_FILE_PATH);
    }

    public static File getTransactionsLogFile() {
        return new File(LoggerVS.TRANSACTIONS_LOG_FILE_PATH);
    }

    public static File getCurrencyIssuedLogFile() {
        return new File(LoggerVS.CURRENCY_ISSUED_LOG_FILE_PATH);
    }
