        ...
        <div class="mainDiv">
            ...
            <template is="dom-repeat" items="{{fieldsEventVS}}">
                <div class="" style="font-size: 2em; border-bottom: 1px solid #888;">
                    <div style="color: #888;padding:0 0 0 10px;text-align: center;">
                        {{item.content}}
                    </div>
                    <div style="padding:0 30px 0 0; background-color: #efefef; font-style: italic;text-align: right;">
                        {{item.numVotes}} ${msg.votesLbl}</div>
                </div>
            </template>
        </div>
    </template>
