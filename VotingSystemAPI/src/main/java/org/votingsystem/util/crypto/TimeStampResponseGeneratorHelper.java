...
public class TimeStampResponseGeneratorHelper {
    ...
    public TimeStampResponseGeneratorHelper(InputStream requestInputStream, SignatureData signingData, Date timeStampDate)
            throws Exception {
        ...
        timeStampResponse = getTimeStampResponse(timeStampRequest, signingData, timeStampDate);
    }
    ...
    public TimeStampResponse getTimeStampResponse(TimeStampRequest tsRequest, SignatureData signingData,
                                                  Date timestampDate) throws Exception {
        ...
        ContentSigner sigGen = new JcaContentSignerBuilder(SIGNATURE_ALGORITHM).setProvider(
                ContextVS.PROVIDER).build(signingData.getSigningKey());
        ...
        signedAttributes = signedAttributes.add(PKCSObjectIdentifiers.pkcs_9_at_signingTime, new Time(timestampDate));
        ...
        return generator.generate(tsRequest, serialNumber, timestampDate);
    }
