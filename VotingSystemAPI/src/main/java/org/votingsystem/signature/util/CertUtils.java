...
public class CertUtils {
    ...
    public static Map<String, String> getCertExtensionData(X509Certificate x509Certificate,
           String extensionOID) throws IOException {
    ...
    public static String getHashCertVS(X509Certificate x509Cert, String oid) throws IOException {
        Map<String, String> map = getCertExtensionData(x509Cert, oid);
        return map.get("hashCertVS");
    }
