...
@Entity @Table(name="FieldEvent")
@JsonIgnoreProperties(ignoreUnknown = true)
public class FieldEvent extends EntityVS implements Serializable {

    private static final long serialVersionUID = 1L;

    private static Logger log = Logger.getLogger(FieldEvent.class.getName());
    ...
    @Column(name="dateCreated") @JsonIgnore private Date dateCreated;
    @Temporal(TemporalType.TIMESTAMP)
    @Column(name="lastUpdated") @JsonIgnore private Date lastUpdated;
    ...
    public FieldEvent(String content, String value) {
        this.content = content;
        this.value = value;
    }

    public FieldEvent(EventVS eventVS, String content) {
        this.eventVS = eventVS;
        this.content = content;
    }

    public FieldEvent(EventVS eventVS, String content, Long accessControlFieldEventId) {
        this.eventVS = eventVS;
        this.content = content;
