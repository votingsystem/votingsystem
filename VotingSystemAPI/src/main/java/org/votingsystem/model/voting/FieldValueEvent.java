...
@Entity @Table(name="FieldValueEvent")
public class FieldValueEvent extends EntityVS implements Serializable {
    ...
    public FieldValueEvent(CMSMessage cmsMessage, FieldEvent fieldEvent, String value) {
