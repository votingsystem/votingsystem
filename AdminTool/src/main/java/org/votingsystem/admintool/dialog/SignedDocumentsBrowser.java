...
public class SignedDocumentsBrowser extends JDialog {
    ...
    public void setVisible(String decompressedBackupBaseDir) {
        ...
        /*try {
            ...
            new File(AdminToolContext.DEFAULTS.APPTEMPDIR + File.separator +
                    zip.getName()).mkdirs();
            ...
            contexto = AdminToolContext.EXPLORANDO_DIRECTORIO;
            openFile(archivo);
            showProgress(false);
        } catch (Exception ex) {
            logger.error(ex.getMessage(), ex);
