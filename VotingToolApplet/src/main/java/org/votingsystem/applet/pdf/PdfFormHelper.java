...
public class PdfFormHelper {
    ...
    static PdfPCellEvent eventIdPdfPCellEvent = new PdfPCellEvent() {
        ...
        public void cellLayout(PdfPCell cell, Rectangle rectangle, PdfContentByte[] canvases) {
            ...
            text.setText(ContextVS.INSTANCE.getString("eventIdPdfPCellEventLbl"));
            text.setFontSize(0);
    ...
    static PdfPCellEvent subjectPdfPCellEvent = new PdfPCellEvent() {
        ...
        public void cellLayout(PdfPCell cell, Rectangle rectangle, PdfContentByte[] canvases) {
            ...
            //text.setBorderStyle(PdfBorderDictionary.STYLE_BEVELED);
            text.setText(ContextVS.INSTANCE.getString("subjectPdfPCellEvent"));
            text.setFontSize(0);
            text.setAlignment(Element.ALIGN_CENTER);
            text.setOptions(TextField.REQUIRED);
            try {
    ...
    static PdfPCellEvent emailCellEvent = new PdfPCellEvent() {
        ...
        public void cellLayout(PdfPCell cell, Rectangle rectangle, PdfContentByte[] canvases) {
            ...
            //text.setBorderStyle(PdfBorderDictionary.STYLE_BEVELED);
            text.setText(ContextVS.INSTANCE.getString("emailCellEventLbl"));
            text.setFontSize(0);
            text.setAlignment(Element.ALIGN_CENTER);
            text.setOptions(TextField.REQUIRED);
            try {
    ...
    public static byte[] getBackupRequest(
        ...
        table.addCell(ContextVS.INSTANCE.getString("eventIdLbl") + ":");
        cell = new PdfPCell();
        cell.setCellEvent(eventIdPdfPCellEvent);
        table.addCell(cell);
        
        table.addCell(ContextVS.INSTANCE.getString("subjectLbl") + ":");
        cell = new PdfPCell();
        cell.setCellEvent(subjectPdfPCellEvent);
        table.addCell(cell);
        
        table.addCell(ContextVS.INSTANCE.getString("emailApplicantLbl") + ":");
        cell = new PdfPCell();
