...
ContextVS.getInstance().initTestEnvironment("log4jTests.properties",
        Thread.currentThread().getContextClassLoader().getResourceAsStream("config.properties"));
Logger logger = Logger.getLogger(VicketRequest.class);
...
try {
    ...
    SMIMEMessageWrapper smimeMessage = signatureVSService.getTimestampedSignedMimeMessage(fromUserVS.nif,
