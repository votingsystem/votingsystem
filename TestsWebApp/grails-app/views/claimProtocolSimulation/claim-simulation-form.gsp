    ...
    <script>
        Polymer('claim-simulation-form', {
            ...
            submitForm: function(e) {
                ...
                var dateFinishStr = getDatePickerValue('dateFinish', this.$.dateFinish).format()
            ...
            isValidForm: function(e) {
                ...
                var accessControlURL = this.$.accessControlURL.value
                var suffix = "/"
                ...
                this.$.accessControlURL.value = accessControlURL
