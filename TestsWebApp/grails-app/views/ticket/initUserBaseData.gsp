...
<div id="ticketUserBaseDataSinulationDataDialog"
    ...
    <div id="formDataDiv">
        <form id="ticketUserBaseDataSinulationDataForm">
            <input type="hidden" autofocus="autofocus" />
            <input id="resetticketUserBaseDataSinulationDataForm" type="reset" style="display:none;">
...
//$("#resetticketUserBaseDataSinulationDataForm").click()
...
$('#ticketUserBaseDataSinulationDataForm').submit(function(event){
...
function showErrorMsg(errorMsg) {
	$("#ticketUserBaseDataSinulationDataDialog .errorMsgWrapper").html('<p>' + errorMsg + '<p>')
	$("#ticketUserBaseDataSinulationDataDialog .errorMsgWrapper").fadeIn()
}
