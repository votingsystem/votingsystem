    ...
    extends SMIMEGenerator
{
    ...
    {
        _signers.add(new SMIMESignedGenerator.Signer(key, cert, digestOID, null, null));
    }
    ...
    public void addSigner(
        ...
        throws IllegalArgumentException
    {
        _signers.add(new SMIMESignedGenerator.Signer(key, cert, encryptionOID, digestOID, null, null));
    }
    ...
    public void addSigner(
        ...
        throws IllegalArgumentException
    {
        _signers.add(new SMIMESignedGenerator.Signer(key, cert, digestOID, signedAttr, unsignedAttr));
    }
    ...
    public void addSigner(
        ...
        throws IllegalArgumentException
    {
        _signers.add(new SMIMESignedGenerator.Signer(key, cert, encryptionOID, digestOID, signedAttr, unsignedAttr));
    }
    ...
    public static String addHashHeader(
        StringBuffer header,
        List         signers)
    {
        int                 count = 0;
        ...
        while (it.hasNext())
        {
            ...
            if (signer instanceof SMIMESignedGenerator.Signer)
            {
                digestOID = ((SMIMESignedGenerator.Signer)signer).getDigestOID();
            }
        ...
        throws NoSuchAlgorithmException, SMIMEException
    {
        try
        {
            ...
            sig.setContent(new SMIMESignedGenerator.ContentSigner(content, false, sigProvider), DETACHED_SIGNATURE_TYPE);
        ...
        throws NoSuchAlgorithmException, SMIMEException
    {
        try
        {
            ...
            sig.setContent(new SMIMESignedGenerator.ContentSigner(content, true, sigProvider), ENCAPSULATED_SIGNED_CONTENT_TYPE);
        ...
        throws SMIMEException
    {
        try
        {
            ...
            sig.setContent(new SMIMESignedGenerator.ContentSigner(content, true), ENCAPSULATED_SIGNED_CONTENT_TYPE);
            sig.addHeader("Content-Type", ENCAPSULATED_SIGNED_CONTENT_TYPE);
            sig.addHeader("Content-Disposition", "attachment; filename=\"smime.p7m\"");
            sig.addHeader("Content-Description", "S/MIME Cryptographic Signed Data");
            sig.addHeader("Content-Transfer-Encoding", encoding);
       ...
       throws SMIMEException
    {
        try
        {
            ...
            sig.setContent(new SMIMESignedGenerator.ContentSigner(null, true, provider), CERTIFICATE_MANAGEMENT_CONTENT);
