...
public class PDFSignerDNIe {
    ...
    private static org.slf4j.Logger logger = LoggerFactory.getLogger(PDFSignerDNIe.class);
     ...
     public static void sign(String reason, String location, char[] password, 
        ...
        PdfSignature dic = new PdfSignature(PdfName.ADOBE_PPKLITE, PDF_SIGNATURE_NAME);
