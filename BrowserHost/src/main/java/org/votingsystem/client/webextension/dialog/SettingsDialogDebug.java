 ...
 */
public class SettingsDialogDebug extends DialogVS implements DeviceSelectorDialog.Listener {

    private static Logger log = Logger.getLogger(SettingsDialogDebug.class.getName());
    ...
    private void changeCryptoToken(ActionEvent evt) {
        ...
        if(evt.getSource() == signWithKeystoreRb) {
            ...
            if(BrowserSessionService.getInstance().getKeyStoreUserVS() != null) {
                ...
                deviceVSDto = ContextVS.getInstance().getKeyStoreDevice();
            }
        }
    ...
    @Override public void show() {
        ...
        CryptoTokenVS cryptoToken = BrowserSessionService.getCryptoTokenType();
        if(cryptoToken != null) {
    ...
    public static void showDialog() {
        Platform.runLater(() -> {
            SettingsDialogDebug settingsDialogDebug = new SettingsDialogDebug();
            settingsDialogDebug.show();
        });
    }
        ...
        try {
            ...
            if (file != null) {
                ...
                PasswordDialog.showWithPasswordConfirm(password -> {
                    ...
                    try {
                        selectedKeyStore = KeyStoreUtil.getKeyStoreFromBytes(keystoreBytes, password);
