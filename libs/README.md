La librería 'plugin-1.3.jar' es necesaria para que los Applets puedan comunicarse mediante Javascript con la interfaz de usuario web, se emplea en los proyectos 'ValidationToolApplet' y 'VotingToolApplet'. 
