...
public class EncryptedMsgReader implements MessageBodyReader<EncryptedMsgDto> {
    ...
    @Override
    public EncryptedMsgDto readFrom(Class<EncryptedMsgDto> aClass, Type type, Annotation[] annotations, javax.ws.rs.core.MediaType mediaType,
