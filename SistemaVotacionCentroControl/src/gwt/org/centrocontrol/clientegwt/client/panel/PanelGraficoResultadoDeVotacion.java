...
public class PanelGraficoResultadoDeVotacion extends Composite implements SolicitanteEmail {
	...
	EstadisticaJso estadisticasCentroControl;
	...
	@UiField Label statusControlAccesoLabel;
	...
	public void mostraEstadisticas(EventoSistemaVotacionJso evento, 
	    ...
	    this.estadisticasCentroControl  = estadisticas;
	    getEstadisticasControlAcceso(ServerPaths.getUrlEstadisticasControlAcceso(
	    		evento.getControlAcceso().getServerURL(), evento.getEventoVotacionId()));
	}

	public void mostraEstadisticasControlAcceso(final EstadisticaJso estadisticas) {
		logger.info("mostraEstadisticasCentroControl - estadisticas:" + estadisticas.toJSONString());
		estadisticasControlAcceso = estadisticas;
    	...
    	jsonp.requestObject(url, new AsyncCallback<EstadisticaJso>() {
    		public void onFailure(Throwable throwable) {
    			...
    			if(throwable instanceof TimeoutException) {
    				statusControlAccesoLabel.setText(Constantes.INSTANCIA.statusControlAccesoError());
    			}
    		}

    		public void onSuccess(EstadisticaJso estadisticas) {
    			logger.info("Obtenidas estadísticas del Control de Acceso");
    			mostraEstadisticasControlAcceso(estadisticas);
    		}
	    });
    }
