...
public final class MensajeClienteFirmaJso extends JavaScriptObject {
    ...
    public static enum Operacion {ASOCIAR_CENTRO_CONTROL, 
        ...
        MENSAJE_APPLET, MENSAJE_CIERRE_APPLET,
        GUARDAR_RECIBO_VOTO, ANULAR_VOTO, CANCELAR_EVENTO, MENSAJE_HERRAMIENTA_VALIDACION,
        MENSAJE_CIERRE_HERRAMIENTA_VALIDACION, ANULAR_SOLICITUD_ACCESO}
