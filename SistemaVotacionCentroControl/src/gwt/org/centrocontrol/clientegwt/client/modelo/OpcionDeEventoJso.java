...
public final class OpcionDeEventoJso extends JavaScriptObject {
	...
	public static native OpcionDeEventoJso create(String contenido, int id, 
			double numeroVotos, EventoSistemaVotacionJso eventoSistemaVotacion) /*-{
	...
	public final native String getOpcionDeEventoId() /*-{
		return this.opcionDeEventoId;
	}-*/;
	...
	public final native double getNumeroVotos() /*-{
		return this.numeroVotos;
	}-*/;

	public final native void setNumeroVotos(double value) /*-{
