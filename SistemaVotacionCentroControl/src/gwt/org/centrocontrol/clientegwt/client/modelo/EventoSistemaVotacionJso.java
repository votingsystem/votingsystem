...
public final class EventoSistemaVotacionJso extends JavaScriptObject {
	...
	public final native void setId(int value) /*-{
 	...
 	public final native String getEventoVotacionId() /*-{
		return this.eventoVotacionId;
	}-*/;
	...
	public final native void setNumerTotalFirmas(int numeroFirmasRecibidas) /*-{
		this.numeroTotalFirmas = value;
	}-*/;
