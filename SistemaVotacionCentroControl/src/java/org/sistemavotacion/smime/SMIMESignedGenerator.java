    ...
    extends SMIMEGenerator
{
    ...
    public void removeSigners(SignerInformationStore signerStore) {
        Iterator    it = signerStore.getSigners().iterator();
        while (it.hasNext()) {
            _oldSigners.remove(it.next());
        }
    }
    ...
    public void removeCertificates(Store certStore){
        certStores.remove(certStore);
    }
    ...
    public void removeCRLs(Store crlStore) {
        crlStores.remove(crlStore);
    }
    ...
    public void removeAttributeCertificates(Store certStore) {
        attrCertStores.remove(certStore);
    }
