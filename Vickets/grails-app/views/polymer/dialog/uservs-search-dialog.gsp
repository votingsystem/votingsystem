...
<link rel="import" href="<g:createLink  controller="polymer" params="[element: '/polymer/uservs-search']"/>">

<polymer-element name="uservs-search-dialog" attributes="transactionvsURL opened">
    <template>
        <votingsystem-dialog id="xDialog" class="uservsSearchDialog" on-core-overlay-open="{{onCoreOverlayOpen}}" style="overflow: auto;">
            ...
            <div id="main">
                <div layout horizontal center center-justified>
                    <div flex style="font-size: 1.5em; margin:5px 0px 10px 10px;font-weight: bold; color:#6c0404;">
                        <div style="text-align: center;"><g:message code="userSearchLbl"/></div>
                    </div>
