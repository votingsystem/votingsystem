...
<body>
    ...
    <div class="text-justify" style="width:800px; margin: 0 auto 0 auto; font-size: 1.2em;">
...
<br>
    <div class="text-justify" style="width:800px; margin: 20px auto 0 auto;font-size: 1.2em;">
        <h3 class="page-header">Preguntas frecuentes</h3>
        <p><b>¿Qué es un Vicket?</b> Es un certificado electrónico que tiene asocidado un valor y que puede ser
